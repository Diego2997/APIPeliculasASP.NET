...
namespace APIPeliculas
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Support IDentity
            builder.Services.AddIdentity<AppUser,IdentityRole>().AddEntityFrameworkStores<APIContext>();
            ...
            builder.Services.AddSwaggerGen(options =>
            {
                options.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    ...
                    $"enter the word 'Bearer' followed by a space and then the token " +
                    "Example : 'Bearer asd121fasdfa3r23r'",
                    Name = "Authorization",
            ...
            //CORS
            builder.Services.AddCors(c => c.AddPolicy("PolicyCors", build =>
            {
